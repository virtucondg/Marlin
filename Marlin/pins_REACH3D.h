...
/**
 * Arduino Mega with RAMPS v1.4 (or v1.3) pin assignments for Reach3D Printer or Reach3D Printer with custom daughterboard
 *
...
#ifndef BOARD_NAME
	#if MB(REACH3D)
		#define BOARD_NAME "Reach3D"
	#elif MB(REACH3DXL)
		#define BOARD_NAME "Reach3DXL"	
	#endif
#endif
